...
/** Parameters */
var numTimesToSubdivide = 4;//图案层次
var theta=60;
var twist=true;//扭转图案
...
window.onload = function initTriangles(){
	...
	var vertices = [
		//逆时针旋转a度
        radius * Math.cos((90-180) * Math.PI / 180.0), radius * Math.sin((90-180) * Math.PI / 180.0),  0,
        radius * Math.cos((210-180) * Math.PI / 180.0), radius * Math.sin((210-180) * Math.PI / 180.0),  0,
        radius * Math.cos((-30-180) * Math.PI / 180.0), radius * Math.sin((-30-180) * Math.PI / 180.0),  0
